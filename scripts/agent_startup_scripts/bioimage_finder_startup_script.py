...
- When querying based on the users' prompt you should generally make a very brief search query string.
- Use the search query format "<keyword 1> OR <keyword 2> [...]", before any other queries.
